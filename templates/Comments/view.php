    ...
    <div class="column-responsive column-80">
        <div class="comments view content">
            ...
            <table>
                ...
                <tr>
                    <th><?= __('User') ?></th>
                    <td><?= $comment->has('user') ? $this->Html->link($comment->user->name . ' ' . $comment->user->lastname, ['controller' => 'Users', 'action' => 'view', $comment->user->id]) : '' ?></td>
                </tr>
                <tr>
                    <th><?= __('Active') ?></th>
            ...
            <div class="text">
                ...
                <blockquote>
                    <?= $this->Text->autoParagraph(h($comment->response)); ?>
                </blockquote>
            </div>
        </div>
    </div>
